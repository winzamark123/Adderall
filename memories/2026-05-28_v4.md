...
- Shared lease manager and models in `AdderallShared`.
...
The lease store is persistence, not IPC.
...
- `AdderallShared`: shared lease models, command parsing, XPC protocol definitions, and power-state abstractions.
